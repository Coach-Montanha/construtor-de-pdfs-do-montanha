...
import { n as generateTempAccessInvite, r as validateEmailMx } from "./ecosystem-auth-service-BvL4SRp3.mjs";
import { o as require_jsx_runtime, s as require_react } from "../_libs/@radix-ui/react-collection+[...].mjs";
import { H as RefreshCw, K as Plus, Qt as CircleX, R as Search, ct as LockOpen, en as CircleCheck, g as TriangleAlert, k as Sparkles, s as Users, st as Lock, v as Trash2 } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/master-admin-Du5eKSc7.js
...
var MasterAdminDashboard = () => {
	...
	const [newProjectId, setNewProjectId] = (0, import_react.useState)("construtor-pdf");
	...
	const MOCK_SUBSCRIPTIONS = [
		{
			...
			payment_status: "PAGO",
			access_expires_at: new Date(Date.now() + 31536e6).toISOString(),
			is_active: true,
		...
		},
		{
			...
			payment_status: "PAGO",
			access_expires_at: new Date(Date.now() + 7776e6).toISOString(),
			is_active: true,
			created_at: (/* @__PURE__ */ new Date()).toISOString()
		},
		{
			...
			access_expires_at: new Date(Date.now() + 6048e5).toISOString(),
			is_active: true,
			created_at: (/* @__PURE__ */ new Date()).toISOString()
		},
		{
			...
			access_expires_at: (/* @__PURE__ */ new Date(Date.now() - 432e6)).toISOString(),
			is_active: false,
			created_at: (/* @__PURE__ */ new Date()).toISOString()
		},
		{
			...
			payment_status: "PAGO",
			access_expires_at: new Date(Date.now() + 15552e6).toISOString(),
			is_active: true,
			created_at: (/* @__PURE__ */ new Date()).toISOString()
		}
	];
	...
	const handleStatusChange = (id, newStatus) => {
		const updated = subscriptions.map((sub) => sub.id === id ? {
			...sub,
	...
	const handleCreateSubscription = async (e) => {
		...
		const newSub = {
			...
			access_expires_at: newExpiresAt ? new Date(newExpiresAt).toISOString() : new Date(Date.now() + 2592e6).toISOString(),
			is_active: true,
			created_at: (/* @__PURE__ */ new Date()).toISOString()
		};
